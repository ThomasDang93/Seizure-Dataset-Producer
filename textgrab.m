function textgrab = textgrab(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   CHB01SUMMARY = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   CHB01SUMMARY = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   chb01summary = importfile('chb01-summary.txt', 1, 209);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/07/03 15:09:52
